...
import com.google.samples.apps.sergio.nearby.MetadataResolver;
import com.google.samples.apps.sergio.nearby.NearbyDeviceManager;
import com.google.samples.apps.sergio.ui.widget.ScrimInsetsFrameLayout;
...
public abstract class BaseMapActivity extends BaseActivity implements NearbyFragment.Callbacks, ScrimInsetsFrameLayout.OnInsetsCallback {
    ...
    public static final String EXTRA_DETACHED_MODE
            = "com.google.samples.apps.sergio.EXTRA_DETACHED_MODE";
