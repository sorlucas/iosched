...
package com.google.samples.apps.sergio.ui;
...
import com.google.samples.apps.sergio.BuildConfig;
import com.google.samples.apps.sergio.Config;
import com.google.samples.apps.sergio.R;
import com.google.samples.apps.sergio.gcm.ServerUtilities;
import com.google.samples.apps.sergio.io.JSONHandler;
import com.google.samples.apps.sergio.provider.ScheduleContract;
import com.google.samples.apps.sergio.sync.ConferenceDataHandler;
import com.google.samples.apps.sergio.sync.SyncHelper;
import com.google.samples.apps.sergio.ui.debug.DebugActionRunnerActivity;
import com.google.samples.apps.sergio.ui.widget.MultiSwipeRefreshLayout;
import com.google.samples.apps.sergio.ui.widget.ScrimInsetsScrollView;
import com.google.samples.apps.sergio.util.AccountUtils;
import com.google.samples.apps.sergio.util.AnalyticsManager;
import com.google.samples.apps.sergio.util.HelpUtils;
import com.google.samples.apps.sergio.util.ImageLoader;
import com.google.samples.apps.sergio.util.LUtils;
import com.google.samples.apps.sergio.util.LoginAndAuthHelper;
import com.google.samples.apps.sergio.util.PlayServicesUtils;
import com.google.samples.apps.sergio.util.PrefUtils;
import com.google.samples.apps.sergio.util.RecentTasksStyler;
import com.google.samples.apps.sergio.util.UIUtils;
import com.google.samples.apps.sergio.util.WiFiUtils;
...
import static com.google.samples.apps.sergio.util.LogUtils.LOGI;
import static com.google.samples.apps.sergio.util.LogUtils.LOGW;
