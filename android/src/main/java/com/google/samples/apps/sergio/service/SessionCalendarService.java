...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "com.google.samples.apps.sergio.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "com.google.samples.apps.sergio.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "com.google.samples.apps.sergio.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "com.google.samples.apps.sergio.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "com.google.samples.apps.sergio.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "com.google.samples.apps.sergio.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "com.google.samples.apps.sergio.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "com.google.samples.apps.sergio.extra.SESSION_BLOCK_END";
    public static final String EXTRA_SESSION_TITLE =
            "com.google.samples.apps.sergio.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "com.google.samples.apps.sergio.extra.SESSION_ROOM";
     ...
     * {@link com.google.samples.apps.sergio.provider.ScheduleProvider}, adding or removing
