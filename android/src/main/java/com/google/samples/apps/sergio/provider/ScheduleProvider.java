...
package com.google.samples.apps.sergio.provider;

import com.google.samples.apps.sergio.appwidget.ScheduleWidgetProvider;
import com.google.samples.apps.sergio.provider.ScheduleContract.Announcements;
import com.google.samples.apps.sergio.provider.ScheduleContract.PeopleIveMet;
import com.google.samples.apps.sergio.provider.ScheduleContract.Blocks;
import com.google.samples.apps.sergio.provider.ScheduleContract.Experts;
import com.google.samples.apps.sergio.provider.ScheduleContract.Feedback;
import com.google.samples.apps.sergio.provider.ScheduleContract.MapMarkers;
import com.google.samples.apps.sergio.provider.ScheduleContract.MapTiles;
import com.google.samples.apps.sergio.provider.ScheduleContract.Rooms;
import com.google.samples.apps.sergio.provider.ScheduleContract.SearchSuggest;
import com.google.samples.apps.sergio.provider.ScheduleContract.Sessions;
import com.google.samples.apps.sergio.provider.ScheduleContract.Speakers;
import com.google.samples.apps.sergio.provider.ScheduleContract.Tags;
import com.google.samples.apps.sergio.provider.ScheduleDatabase.SessionsSearchColumns;
import com.google.samples.apps.sergio.provider.ScheduleDatabase.SessionsSpeakers;
import com.google.samples.apps.sergio.provider.ScheduleDatabase.Tables;
import com.google.samples.apps.sergio.util.SelectionBuilder;
...
import com.google.samples.apps.sergio.Config;
import com.google.samples.apps.sergio.appwidget.ScheduleWidgetProvider;
import com.google.samples.apps.sergio.provider.ScheduleContract.*;
import com.google.samples.apps.sergio.provider.ScheduleDatabase.SessionsSearchColumns;
import com.google.samples.apps.sergio.provider.ScheduleDatabase.SessionsSpeakers;
import com.google.samples.apps.sergio.provider.ScheduleDatabase.Tables;
import com.google.samples.apps.sergio.util.AccountUtils;
import com.google.samples.apps.sergio.util.SelectionBuilder;
...
import static com.google.samples.apps.sergio.util.LogUtils.LOGV;
 ...
 * by {@link com.google.samples.apps.sergio.sync.SyncHelper}, and queried by various
