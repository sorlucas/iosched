...
import com.google.samples.apps.sergio.model.TagMetadata;
import com.google.samples.apps.sergio.provider.ScheduleContract;
import com.google.samples.apps.sergio.service.SessionAlarmService;
import com.google.samples.apps.sergio.service.SessionCalendarService;
import com.google.samples.apps.sergio.ui.widget.CheckableFrameLayout;
import com.google.samples.apps.sergio.ui.widget.MessageCardView;
import com.google.samples.apps.sergio.ui.widget.ObservableScrollView;
import com.google.samples.apps.sergio.util.AccountUtils;
import com.google.samples.apps.sergio.util.AnalyticsManager;
import com.google.samples.apps.sergio.util.BeamUtils;
import com.google.samples.apps.sergio.util.ImageLoader;
import com.google.samples.apps.sergio.util.LogUtils;
import com.google.samples.apps.sergio.util.SessionsHelper;
...
public class SessionDetailActivity extends BaseActivity implements
    ...
    /**
     * {@link com.google.samples.apps.sergio.provider.ScheduleContract.Sessions} query parameters.
     */
